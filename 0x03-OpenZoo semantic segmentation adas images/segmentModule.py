...
def load_model(model):
    if(model=='road-segmentation-adas-0001'):
        model = core.read_model(model='./models/road-segmentation-adas-0001.xml')
    elif(model=='semantic-segmentation-adas-0001'):
...
def postprocess(frame, model_name, model_result, height, width, alpha = 0.3):
    ...
    """
    if(model_name=='road-segmentation-adas-0001'):
        # Constants
    ...
    elif(model_name=='semantic-segmentation-adas-0001'):
        # Constants
