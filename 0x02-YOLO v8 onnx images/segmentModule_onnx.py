    ...
    try:
        ...
        boxes, scores, class_ids, masks = \
            segment_objects(session, input_names, output_names, conf_thres, iou_thres, \
                            num_masks, img, img_height, img_width, input_height, input_width)
        print("Executing output_fn from inference.py ...")
        output_image = draw_masks(img, boxes, scores, class_ids, masks)
...
# response = segment("./data/d3f34243-a7166713.jpg")
# print(response)